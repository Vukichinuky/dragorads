            ...
            {links2.map((link1) => (
                <div key={link1.names}>
                    <div className=" flex  flex-col items-center  text-left md:cursor-pointer group">
                        <h1
                            className=" bg-zinc-700  hover:bg-yellow-500 hover:text-white text-slate-400  rounded-3xl md:py-4    p-3
               my-1 mt-3 md:mx-10  group"

                            onClick={() => {
                                heading !== link1.names ? setHeading(link1.names) : setHeading("");
                                setSubHeading("");
                            }}
                        >
                            {link1.names}
                            <span className="text-xl md:hidden inline">
                                <ion-icon
                                    names={`${heading === link1.names ? "chevron-up" : "chevron-down"
                                        }`}
                                ></ion-icon>
                            </span>
                                        ...
                                        {link1.sublinks.map((mysublinks) => (
                                            <div key={link1.names}>
                                                ...
                                                {mysublinks.sublink.map((slink44) => (
                                                    <li key={link1.names} className="    text-slate-400  hover:bg-yellow-500 hover:text-white z-50 bg-zinc-700 py-4 px-5 rounded-3xl">
                                                        <Link
                                                            href={slink44.link1}
                                                        >
                                                            {slink44.names}
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <span className="text-xl md:mt-1  md:ml-2 inline">
                                            <ion-icon
                                                names={`${subHeading === slinks23.Head
                                                    ? "chevron-up"
                                                    : "chevron-down"
                                                    }`}
                                            ></ion-icon>
                                    ...
                                    <div
                                        className={`${subHeading === slinks23.Head ? "md:hidden" : "hidden"
                                            }`}
                                    >
                                        {slinks23.sublink.map((slink44) => (
                                            <li key={link1.names} className="hover:text-yellow-400  text-center">
