...
export default function Footer() {
  return (
    <footer className=' text-white text-opacity-60'>
      <div className='h-2xl text-xs sm:grid sm:grid-cols-3 bg-orange-300'>
        ...
        <div>
          ...
          <div className="flex items-center   justify-center">
            ...
            <Link href={'https://www.google.com/maps/place/O%C5%A0+%22Vuk+Karad%C5%BEi%C4%87%22+-+Ro%C4%87evi%C4%87/@44.535909,19.1437763,15z/data=!4m6!3m5!1s0x475961b2c4b213a1:0x7f9d16c6ff6ca75e!8m2!3d44.535909!4d19.1437763!16s%2Fg%2F11jjw7kvpz'}>
              <svg className=" w-16 p-2 m-3 opacity-60 cursor-pointer h-16 " viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center my-4 justify-center">
            <img className="w-16 h-16 opacity-60 p-2 m-3 ml-6" src="/email.png" alt="" />
            <h6 className=" m-2 ">
              Е-маил: : <br />
              os147@skolers.org
          ...
          <div className="flex items-center my-4 justify-center">
            <img className="w-16 h-16 opacity-60 p-2 m-3 ml-20 " src="/phone-call.png" alt="" />
            <h6 className=" m-2 ">
              Тел.: +387 56/398-082; <br /> тел.: 056/398-615, <br /> 056/490-890, 056/490-891
        ...
        <div>
          <h5 className=' text-center font-bold text-xl  p-10'>Пратите нас</h5>
          <div className="flex cursor-pointer my-4 justify-center">
            <Link href='https://www.facebook.com/juosvukkaradzic.rocevic'><img className="w-16  opacity-70 " src="/facebook123.png" alt="facebook logo" /></Link>


          </div>
          <div className="flex cursor-pointer my-4 justify-center">
            <Link href='https://www.instagram.com/osnovnaskolarocevic'><img className="w-14  opacity-60 " src="/instagram.png" alt="facebook logo" /></Link>
        ...
        <div>
          <h5 className=' text-center font-bold text-xl  p-10'>Сајт опремио</h5>
          <div className="flex  my-4 justify-center">


          </div>
          <div className="flex text-xs align-middle items-center my-4 justify-center">
            <img className="w-16 h-16 opacity-60 p-2 mx-3 ml-20" src="/email.png" alt="" />
            <h6 className=" m-2 ">
              Е-маил: : <br />
              tubic.jovan96@outlook.com <br />
              drvuk23@gmail.com.com
      ...
      <hr />
      <p className='text-center p-2 px-10 text-xs bg-orange-300'>© {currentYear}  Сва права задржана. ЈУ Основна школа “Вук Караџић"</p>
