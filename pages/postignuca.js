                ...
                <section>
                    ...
                    <div className=''>
                        ...
                        <div className=' text-center mt-28  max-w-6xl m-auto relative   z-10 '>
                            ...
                            <h2 className=' font-bold  ml-10  italic  sm:text-2xl'>Најважнији успјеси школе</h2>

                            <p className='m-4 text-m text-center sm:text-base mt-10'>Иако мала, наша школа је поносна на сваки успијех ђака. Наши ђаци су учесници многобројних такмичења на свим нивоима.
