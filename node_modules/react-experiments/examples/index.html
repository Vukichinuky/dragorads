...
<head>
   <script>
      global = globalThis //<- strange issue attaching planout to the window
    </script>
  <meta charset="UTF-8">
...
<body>
  ...
  <script type="text/jsx">
    var VariationExperiment = createReactClass({
      render: function() {
        return (
          <div className="card">
    ...
    var FooComponent = createReactClass({
      contextTypes: {
    ...
    var TextComponent = createReactClass({
      render: function() {
    ...
    var ParametrizeExperiment = createReactClass({
      render: function() {
        return (
    ...
    var ExperimentExamples = createReactClass({
      render: function() {
        return (
          <div className="wrap">
